...
<div class="contain_nav">
    <nav>
        ...
        ?>
        <div class="x_search" data-pos="0">
            <img src="../img/menuNav.png" class="imgMenu">
            <img src="../img/x.png" class="imgX">
        </div>
        ...
        <div class="contain_search">
            <form action="../controllers/InterestController.php" method="post" class="no-margin flex searchRes" id="frm">
                <div class="conta" id="contain_search">
                    ...
                    <scroll-container class="ocultar scroll-find" id="scroll-find" data-user="<?= $user->id ?>">
    ...
    <div class="black-search">
        <div class="contain_search search-black">
            <form action="../controllers/InterestController.php" method="post" class="no-margin flex searchRes" id="frm">
                <div class="conta" id="contain_search">
                    <input type="text" id="search" autocomplete="off" name="nom" class="input_search no-margin" placeholder="Buscar" />
                    <button type="submit" name="submit" value="search" class="btn_find">
