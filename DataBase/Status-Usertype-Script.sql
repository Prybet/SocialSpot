...
INSERT INTO category VALUES (null, "Cruiser", "Estás suelen ser de ruedas anchas y más suaves, permitiendo ser más practica, ágiles, rápidas y de gran agarre", "Cruise-ProfilePic.jpg", "Cruise-BannerPic.jpg",1);
INSERT INTO category VALUES (null, "Longboard"," Se utilizan comúnmente para bajar cuestas, en carreras que se llevan a cabo en todo el mundo. La forma de la tabla es larga, tiene ruedas anchas y largas", "Longboard-ProfilePic.jpg", "Longboard-BannerPic.jpg",1);
INSERT INTO category VALUES (null, "Patines", "Son unos paratos deportivos o de entretenimiento que  consiste en una plataforma ajustable a la suela del calzado o una bota con esta plataforma adherida, permitiendo hacer trucos en el aire", "Patines-ProfilePic.png", "Patines-BannerPic.jpg",1);
...
(NULL, "Antofagasta", "Antofagasta, también conocida como La Perla del norte, es una ciudad, puerto y comuna del Norte Grande de Chile y es la capital de la provincia y de la región homónima.","","",3,1),
...
INSERT INTO city VALUES 
(NULL, "Chañaral", "La comuna fue fundada el 26 de octubre de 1833 como Chañaral de las Animas. Está ubicada a 167 Km. de Copiapó en la, Provincia de Chañaral, Región de Atacama.","","",6,1),
...
INSERT INTO city VALUES 
(NULL, "Illapel", "Illapel es una comuna de la Provincia de Choapa y se emplaza en la ribera norte y valle del río Illapel, el principal tributario del río Choapa.","","",9,1),
...
INSERT INTO city VALUES 
(NULL, "Isla de Pascua", "Es la única comuna que pertenece a la provincia de Isla de Pascua y agrupa a Isla de Pascua y la Isla Salas y Gómez.","","",12,1),
...
INSERT INTO city VALUES 
(NULL, "Temuco", "La comuna de Temuco cuenta, según el censo de 2017, con una población de 282 415 habitantes, la cual forma junto a Padre Las Casas la conurbación llamada Gran Temuco, conformada en total por 358 541 habitantes, siendo el área metropolitana más poblada del sur del país.","","",25,1),
...
INSERT INTO city VALUES 
(NULL,"Castro","La superficie comunal es de 473 km² y la población total, según el censo de 2017, es de 43 807 habitantes, de los cuales el 77,7 % vive en la ciudad de Castro.","","",27,1),
...
INSERT INTO city VALUES 
(NULL,"Aysén","Se ubica a orillas del río Aysén, 3 km al interior del fiordo de Aysén. Solo en la ciudad tiene una población estimada de 27 000 habitantes en 2017, transformándola en la segunda ciudad de importancia en la región después de la Capital Regional: Coyhaique.","","",31,1),
...
INSERT INTO city VALUES 
(NULL,"Colina ","Es una comuna y ciudad chilena ubicada al norte de la Región Metropolitana de Santiago, en la zona central de Chile. Es la capital de la Provincia de Chacabuco. Dentro de la comuna se encuentran localidades como la ciudad de Colina (capital comunal), Chicureo, Las Canteras y Esmeralda.","","",39,1),
...
INSERT INTO city VALUES 
(NULL,"La Unión","es una pequeña ciudad de 26 000 habitantes que es parte de la Comuna de La Unión y Capital de la Provincia del Ranco en el territorio sur de la Región de Los Ríos. Está ubicada a 40 km al norte de Osorno y a 80 km al sureste de su Capital Regional —Valdivia.","","",43,1),
...
INSERT INTO city VALUES 
(NULL,"Bulnes","Es una comuna ubicada en la provincia de Diguillín, perteneciente a la Región de Ñuble, en la zona central de Chile. Su capital, al igual que de la provincia, es la ciudad de Bulnes. Se ubica a 25 km de Chillán, capital regional. Limita al norte con la comuna de Chillán Viejo, al sur con la comuna de Pemuco, al este con San Ignacio y al oeste con Quillón.","","",47,1),
