...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_POST["submit"] == "recover") {
        ...
        .es-button-border {
            ...
            border-color: #7C72DC #7C72DC #7C72DC #7C72DC;
            background: #7C72DC;
                    ...
                    <table width="600" cellspacing="0" cellpadding="0" border="0" align="center">
                        <tr>
                            <td style="line-height: 1px;min-width: 600px" height="0">
                                <amp-img src="https://jpnfiu.stripocdn.email/content/guids/CABINET_837dc1d79e3a5eca5eb1609bfe9fd374/images/41521605538834349.png" style="display: block;max-height: 0px;min-height: 0px;min-width: 600px;width: 600px" alt width="600" height="1"></amp-img>
                            </td>
                        </tr>
                    </table>
                </td>
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0" role="presentation">
                                                            <tr>
                                                                <td class="es-infoblock es-m-txt-c" align="left">
                                                                    <p style="font-family: arial, helvetica\ neue, helvetica, sans-serif">Recovery SocialSpot<br></p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
...
<td width="278" valign="top"><![endif]-->
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0" role="presentation">
                                                            <tr>
                                                                <td align="right" class="es-infoblock es-m-txt-c">
                                                                    <p><a href="20.226.8.31/SocialSpot/views/index" class="view" target="_blank" style="font-family: \'arial\', \'helvetica neue\', \'helvetica\', \'sans-serif\'">SocialSpot.com</a></p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                    ...
                    <table class="es-header" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                            <td style="background-color: #7c72dc" bgcolor="#7c72dc" align="center">
                                                        ...
                                                        <table style="border-radius: 4px;border-collapse: separate;background-color: #111111" width="100%" cellspacing="0" cellpadding="0" bgcolor="#111111" role="presentation">
                                                            <tr>
                                                                <td class="es-m-txt-l es-p35t es-p30r es-p30l" bgcolor="#111111" align="left">
                                                                    <h2 style="color: #ffffff">Quieres Crear otra cuenta?</h2>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                        ...
                                                        <table style="border-radius: 4px;border-collapse: separate" width="100%" cellspacing="0" cellpadding="0" role="presentation">
                                                            <tr>
                                                                <td class="es-p30t es-p30r es-p30l" align="center">
                                                                    <h3 style="color: #111111">Nesesitas mas ayuda?</h3>
                                                                </td>
                                                            </tr>
                                                            <tr>
