...
<div class="contain_post" id="<?= $post->id ?>"> <!-- data-val="<?= $post->id ?> -->
    ...
    <div class="flex_option">
        <div class="container_option-post">
            <div class="flex_option">
                <button class="heartNotLike" data-post="<?= $post->id ?>" data-user="<?= $_SESSION["user"]->id ?>">
                    ...
                    <label class="cont-pst" for="checkLike">0</label>
                </button>
                
                <button class="heartLike" data-post="<?= $post->id ?>" data-user="<?= $_SESSION["user"]->id ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 512 512">
