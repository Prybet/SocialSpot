                ...
                <?php if ($_SESSION["user"]->userType->id != 2): ?>
                    <?php if($veri == 1):?>
                       <button class="heartLike btnHeartOff_<?= $post->id ?>" data-post="<?= $post->id ?>" data-user="<?= $_SESSION["user"]->id ?>"style="display: flex">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" x="0" y="0" version="1.1" viewBox="0 0 29 29" xml:space="preserve" width="30" height="288">
                                <path d="M14.854 6.083l-.354.353-.354-.354a6.5 6.5 0 0 0-9.192 9.192l.354.354L14.5 24.82l9.192-9.192.354-.354a6.5 6.5 0 0 0-9.192-9.191z" fill="#a61548" class="color000 svgShape"/><path d="M14.854 6.083l-.354.353-.354-.354a6.5 6.5 0 0 0-9.192 9.192l.354.354L14.5 24.82l9.192-9.192.354-.354a6.5 6.5 0 0 0-9.192-9.191z" fill="#a61548" class="color000 svgShape"/>
                            </svg>
